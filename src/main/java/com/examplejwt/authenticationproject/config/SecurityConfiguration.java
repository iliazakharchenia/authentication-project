package com.examplejwt.authenticationproject.config;

import com.examplejwt.authenticationproject.user.UserAuthority;
import com.examplejwt.authenticationproject.user.UserDetailsManagerImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/**").hasAuthority(UserAuthority.ADMIN.toString())
                        .anyRequest().denyAll())
